...
frappe.ui.form.on('Dlits Margin Table Item', {
    cost(frm, cdt, cdn)         { if (frm.doctype === 'Sales Order') _dlits_recalc_row(frm, cdt, cdn); },
    discount_type(frm, cdt, cdn){ if (frm.doctype === 'Sales Order') _dlits_recalc_row(frm, cdt, cdn); },
    discount(frm, cdt, cdn)     { if (frm.doctype === 'Sales Order') _dlits_recalc_row(frm, cdt, cdn); },
});
