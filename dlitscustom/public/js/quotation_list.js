// ── Quotation List — Dlits Followup Status Formatters ────────────────────────
// Extends (does NOT replace) any existing ERPNext Quotation listview settings.
...
(function () {
    ...
    const s = frappe.listview_settings['Quotation'] || {};
    ...
    s.formatters = Object.assign(s.formatters || {}, {
        ...
        custom_last_followup_date: function (value, row) {
            ...
            const aging = row.custom_followup_aging_days || 0;
    ...
    frappe.listview_settings['Quotation'] = s;
})();
