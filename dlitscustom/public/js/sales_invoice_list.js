// ── Sales Invoice List — Dlits Followup Status Formatters ────────────────────
// Extends (does NOT replace) any existing ERPNext Sales Invoice listview settings.
...
(function () {
    ...
    frappe.listview_settings['Sales Invoice'] = s;
})();
